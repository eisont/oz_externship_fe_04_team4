...
export const mockApplicationsDetailMap: Record<number, ApplicationsDetail> = {
  ...
  18: {
    id: 18,
    self_introduction:
      '안녕하세요! 협업 도구와 워크플로우에 관심이 많은 프론트엔드 개발 지망생입니다.',
    motivation:
      'PR 리뷰와 이슈 트래킹을 실제로 경험해보고 싶어서 지원했습니다.',
    objective: 'GitHub 이슈, PR, 코드 리뷰 흐름에 익숙해지는 것이 목표입니다.',
    available_time: '화/목/토 저녁',
    has_study_experience: true,
    study_experience: '버전 관리 기초 스터디를 진행한 경험이 있습니다.',
    status: 'ACCEPTED',
    recruitment: {
      id: 9,
      title: 'Git & GitHub 협업 플로우 스터디',
  ...
  20: {
    id: 20,
    self_introduction:
      '안녕하세요! 클라우드 인프라를 조금 더 깊게 이해하고 싶은 백엔드 지망생입니다.',
    motivation:
      'AWS 기초 개념을 정리하고, 나중에 자격증 준비에도 도움이 될 만한 내용을 배우고 싶습니다.',
    objective:
      '핵심 서비스 개념을 정리한 노트를 만들고, 간단한 실습까지 해보는 것이 목표입니다.',
    available_time: '토/일 오후',
    has_study_experience: true,
    study_experience:
      '학교에서 네트워크 수업을 들은 적이 있고, 관련 내용과 연결해서 공부해보고 싶습니다.',
    status: 'CANCELED',
    recruitment: {
      id: 10,
      title: 'AWS 클라우드 기초 개념 스터디',
